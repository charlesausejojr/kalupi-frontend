...
const Form = () => {
  ...
  useEffect(() => {
    ...
    console.log(user?.result.givenName);
  },[location])

  const clear = () => {
    setQuestionData({ username: '', title: '', description: '', category: '', picture: '', googleId: ''});
    setDescriptionData('');
  };
  ...
  return (
    ...
    <Paper id='popout' variant="outlined" className="form__paper">
      <h3 id='font-custom'>Submit a Question:</h3>
      ...
      <ReactQuill
        ...
        <div className={classes.buttons}>
          ...
          <Button id='font-custom' className={classes.clear} variant="contained" color="secondary" size="small" onClick={clear} >Clear</Button>
        </div>
      </Paper>
      </form>
